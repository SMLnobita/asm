...
kiem_tra_dieu_kien:
    ...
    bne s0, zero, check_conditions       # Nếu N != 0 thì kiểm tra bình thường
    li a0, 0                             # N=0 → không thỏa điều kiện nào
    j kiem_tra_end
...
# SW[9:2] = 00000000 (N=0): LED = 0x0      Trường hợp đặc biệt N=0 → không thỏa
